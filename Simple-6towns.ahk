	...
	{	
		...
		while (bContinueWave)
		{
			IfWinActive, Idle Champions
			{
				...
				if (g_SF.Memory.ReadChampLvlByID(59) < 100)
				{
					Send {F12}
					sleep, 1000
					if (g_SF.Memory.ReadChampLvlByID(59) >= 100)
				...
				if (g_SF.Memory.ReadChampLvlByID(3) < 400)
				{
					Send {F3}
					sleep, 1000
					if (g_SF.Memory.ReadChampLvlByID(3) >= 400)
				...
				if (g_SF.Memory.ReadChampLvlByID(28) < 200)
				{
					Send {F1}
					sleep, 1000
					if (g_SF.Memory.ReadChampLvlByID(28) >= 200)
					{
						MouseClick, L, 890, 640
						sleep, 1000						
					}
					continue
				}	
				if (g_SF.Memory.ReadChampLvlByID(58) < 170)
				{
					Send {F5}
					sleep, 1000
					if (g_SF.Memory.ReadChampLvlByID(58) >= 170)
				...
				if (g_SF.Memory.ReadChampLvlByID(56) < 275)
				{
					Send {F10}
					sleep, 1000
					if (g_SF.Memory.ReadChampLvlByID(56) >= 275)
